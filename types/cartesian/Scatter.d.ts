...
declare class Scatter extends PureComponent<Props, State> {
    ...
    static getComposedData: ({ xAxis, yAxis, zAxis, item, displayedData, onItemMouseLeave, onItemMouseEnter, onItemClick, xAxisTicks, yAxisTicks, offset, }: {
        props: Props;
        xAxis: Pick<YAxisProps, "children" | "height" | "name" | "type" | "width" | "orientation" | "dataKey" | "ticks" | "hide" | "tick" | "tickCount" | "axisLine" | "tickLine" | "tickSize" | "tickFormatter" | "allowDataOverflow" | "allowDuplicatedCategory" | "allowDecimals" | "domain" | "unit" | "axisType" | "range" | "AxisComp" | "padding" | "mirror" | "minTickGap" | "interval" | "reversed" | "yAxisId"> & {
